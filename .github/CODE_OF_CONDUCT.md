...
We as members, contributors, and maintainers pledge to make participation in our community a harassment-free experience 
...
- Showing gratitude and appreciation for contributions
...
This Code of Conduct applies within all project spaces—such as GitHub issues, discussions, pull requests, and any other 
communication channels used by the project—as well as in public spaces when an individual is officially representing 
the project.
...
1. **Correction** — A private, written warning, with clarification on the nature of the violation and an explanation 
...
3. **Temporary Ban** — A temporary removal from interaction with the community for a set period of time.
